...
Minchan: Wrote code to scrape data from PrizePicks website.
David: Wrote code to handle data preprocessing.
Mihir: Wrote code for second model.
Rohil: Wrote writeups for second model (Milestone 4) and completed final writeup.
Jason: 
